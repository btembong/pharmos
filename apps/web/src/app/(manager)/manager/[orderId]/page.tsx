...
export default function ManagerOrderDetailPage() {
  ...
  async function confirmPayment() {
    ...
    try {
      ...
      if (res.ok) { toast.success("Payment confirmed!"); setShowConfirm(false); loadOrder(); }
      else { const err = await res.json().catch(() => ({})); toast.error(err.error || "Failed to confirm"); }
    ...
    <div className="pb-8">
      ...
      <Section title={`Items (${order.items.length})`} icon={Package}>
        ...
        <div className="mt-4 space-y-1.5 border-t border-[#010128]/8 pt-3">
          ...
          <div className="flex justify-between pt-1 text-sm font-bold text-[#010128]">
