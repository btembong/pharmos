...
export function ManagerBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-[#010128]/95 backdrop-blur-md safe-area-bottom">
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center gap-0.5 px-4 py-1 transition-colors ${
                active ? "text-[#7371FC]" : "text-white/40"
              }`}
            >
